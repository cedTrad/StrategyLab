...
# Plot candle
def plot_candle(fig, col, row, data, name):
    fig.add_trace(
        go.Candlestick(
            x = data.index , open = data.open, close = data.close,
            high = data.high, low = data.low, name = name,
        ),
        col = col, row = row
    )
...
def add_line2(fig, data, name, color = None, col = None, row = None):
    fig.add_trace(
        go.Scatter(
            x = data.index,
            y = data,
...
def add_scatter2(fig, data, name, color, col = None, row = None):
    fig.add_trace(
        go.Scatter(
            x = data.index,
            y = data,
